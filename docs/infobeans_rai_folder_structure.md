...
# infobeans-rai Framework - Folder Structure Documentation

## Complete Directory Architecture

This document provides a comprehensive breakdown of every directory and file in the infobeans-rai framework, explaining their purpose, contents, and interdependencies.
...
├── infobeans_rai.py                  # Entry point for test execution
...
### **4. infobeans_rai.py - Main test runner
